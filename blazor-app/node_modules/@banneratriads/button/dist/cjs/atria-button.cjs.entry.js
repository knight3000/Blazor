...
const index = require('./index-804a607c.js');
...
const AtriaButtonComponent = class {
    constructor(hostRef) {
    ...
    render() {
        const classes = [
            ...
            .filter(Boolean)
            .join(' ');
        return (index.h("button", { key: 'f1ccb22e88e0032e9608606bc97bf04e8ec37e35', id: this.buttonId, class: classes, style: { width: this.width }, type: this.buttonRole, onClick: this.onClick, disabled: this.disabled }, this.buttonIconLeft && !this.loading && (index.h("i", { key: '89282a3959bc4554a8549decea903c737ca2c498', class: `left bh-icon bh-icon-md ${this.buttonIconLeft}`, "aria-label": this.buttonText })), this.buttonText, this.buttonIconRight && !this.loading && (index.h("i", { key: '46386ca2945aa40612080999891641920719bbd2', class: `right bh-icon bh-icon-md ${this.buttonIconRight}`, "aria-label": this.buttonText }))));
    }
};
AtriaButtonComponent.style = AtriaButtonStyle0;

exports.atria_button = AtriaButtonComponent;

//# sourceMappingURL=atria-button.cjs.entry.js.map